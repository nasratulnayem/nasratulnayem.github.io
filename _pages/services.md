...
description: "I build fast WordPress sites, WooCommerce stores, API integrations, and automation-first systems. Let's talk about your project."
permalink: /services/
...
<div class="ht-page-hero">
  ...
  <h1 class="ht-page-hero__title">High-performance web systems tailored for your business workflow.</h1>
  <p class="ht-page-hero__desc">I architect customer-facing websites, custom WordPress plugins, and operational tools that are fast, maintainable, and built to eliminate repetitive manual work.</p>
</div>
