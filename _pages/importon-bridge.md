...
<section class="ht-work-section" aria-labelledby="reviews-title">
  ...
  <div class="ht-reviews-viewport" id="htReviewsViewport">
    <div class="ht-reviews-track" id="htReviewsTrack">
      ...
      <article class="bento-card glow-card ht-review-card"><div style="color:#f59e0b;letter-spacing:2px">★★★★★</div><h3 style="margin:0;font-size:15px">Finally sane managing 5 stores</h3><p style="margin:0;color:#475569;font-size:13px;line-height:1.5">We manage 5 WooCommerce stores. Queue 40 Alibaba URLs, AI rewrites descriptions, logs show what failed. Went from a full day of manual work to about an hour.</p><div class="ht-review-author"><img src="https://s3-us-west-2.amazonaws.com/freemius/plugins/28475/reviews/e75043adbe827b1488ddd7d3e4f3ed1b.png" alt="Priya Shah" loading="lazy"><div><strong>Priya Shah</strong><span>Agency Owner, ScaleCommerce</span></div></div></article>
      <article class="bento-card glow-card ht-review-card"><div style="color:#f59e0b;letter-spacing:2px">★★★★★</div><h3 style="margin:0;font-size:15px">Variations and 8 images imported perfectly</h3><p style="margin:0;color:#475569;font-size:13px;line-height:1.5">Imported a jacket with 6 color/size variations — all SKUs and images mapped. What used to be 30 mins per product is now 2 clicks.</p><div class="ht-review-author"><img src="https://s3-us-west-2.amazonaws.com/freemius/plugins/28475/reviews/293a043785ec0b6560924e63953f48f9.jpg" alt="Sofia Mendes" loading="lazy"><div><strong>Sofia Mendes</strong><span>Ecommerce Manager, ModaLuna</span></div></div></article>
      <article class="bento-card glow-card ht-review-card"><div style="color:#f59e0b;letter-spacing:2px">★★★★★</div><h3 style="margin:0;font-size:15px">AI rewrite saved hours of editing</h3><p style="margin:0;color:#475569;font-size:13px;line-height:1.5">OpenAI rewrite gave unique descriptions straight away, no duplicate Alibaba text. Did 15 products in one batch.</p><div class="ht-review-author"><img src="https://s3-us-west-2.amazonaws.com/freemius/plugins/28475/reviews/aeef339b6358dd5138a0775895c25387.jpg" alt="Daniel Kim" loading="lazy"><div><strong>Daniel Kim</strong><span>SEO Specialist, RankPilot</span></div></div></article>
